...
class Widget_Tykes_Home_Hero extends Widget_Base_Tykes {
    ...
    protected function register_controls(): void {
        ...
        $this->add_control( 'description', [
            ...
            'type'    => Controls_Manager::TEXTAREA,
            'default' => 'Tykes Early Years is a professionally structured preschool built on the academic legacy of Kidzonia, offering Nursery, KG, and DayCare across India\'s key cities.',
        ] );
            ...
            <div class="container hero-grid">
                <div class="hero-content">
                    <?php if ( ! empty( $settings['eyebrow'] ) ) : ?>
                        <div class="hero-eyebrow b-poppins"><span class="dot"></span> <?php echo wp_kses_post( $settings['eyebrow'] ); ?></div>
                    <?php endif; ?>
                    ...
                    <div class="hero-btns">
                        <?php if ( ! empty( $settings['btn_primary_text'] ) ) : ?>
                            <a <?php echo $primary_btn_attr; ?> class="btn-orange"><?php echo wp_kses_post( $settings['btn_primary_text'] ); ?></a>
                        <?php endif; ?>
                        
                        <?php if ( ! empty( $settings['btn_secondary_text'] ) ) : ?>
                            <a href="<?php echo esc_url( $secondary_url ); ?>" class="btn-white"><?php echo wp_kses_post( $settings['btn_secondary_text'] ); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="hero-image-wrap">
                    <?php if ( ! empty( $settings['hero_image']['url'] ) ) : ?>
                        <img src="<?php echo esc_url( $settings['hero_image']['url'] ); ?>" alt="Tykes Hero" class="hero-img" style="object-position: top;">
                    <?php endif; ?>
